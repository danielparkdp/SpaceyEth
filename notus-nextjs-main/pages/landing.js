...
export default function Landing() {
  const [dataDecentraland, setDataDecentraland] = useState([]);
  ...
  useEffect(() => {
    (async () => {
      ...
      //setDataDecentraland([result.data.stats.seven_day_volume, result.data.stats.one_day_change, result.data.stats.seven_day_change, result.data.stats.floor_price, result.data.stats.num_owners, result.data.stats.count]);
      ...
      setDataDecentraland([resultDecentraland.data, resultSandbox.data, resultNFTWorlds.data]);
    })();
  }, []);
  ...
  //     {
  //         id: "1",
  //         items: ["Decentraland", dataDecentraland[0], dataDecentraland[1], dataDecentraland[2], dataDecentraland[3], dataDecentraland[4], dataDecentraland[5]],
  //         //items: ["Decentraland", FormatDecimal(dataDecentraland[0]), FormatPercentage(dataDecentraland[1]), FormatPercentage(dataDecentraland[2]), FormatDecimal(dataDecentraland[3]), dataDecentraland[4], dataDecentraland[5]],
  //     },
  //     {
  //         id: "2",
  //         items: ["The Sandbox", 10000],
  //         //items: ["The Sandbox", FormatDecimal(dataDecentraland[0]), FormatPercentage(dataDecentraland[1]), FormatPercentage(dataDecentraland[2]), FormatDecimal(dataDecentraland[3]), dataDecentraland[4], dataDecentraland[5]],
  //     },
  //     {
  //         id: "3",
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="flex flex-wrap items-center mt-32">
              <div className="w-full md:w-8/9 px-4 mr-auto ml-auto">
                ...
                <div>
                    <Table columns={columns} data={dataDecentraland} />
                </div>
